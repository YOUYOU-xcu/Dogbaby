...
<body >
			...
			<div class="search-title">
				...
				<div class="description">
					<a
						href="<%=SystemParam.getSiteRoot()%>/admin/jiaodiantumanager.do?actiontype=load&seedid=206">新建焦点图</a>
				</div>
			</div>
			<!-- 搜索控件开始 -->
				...
				<tbody>
					...
					<c:forEach var="temjiaodiantu" items="${listjiaodiantu}">
						<tr>
							...
							<td>
							    <a class="edit" href="<%=SystemParam.getSiteRoot() %>/admin/jiaodiantumanager.do?actiontype=load&id=${temjiaodiantu.id}&seedid=206">修改</a>
