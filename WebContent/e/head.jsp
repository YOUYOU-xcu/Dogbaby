  <%@ page language="java" import="com.zhang.you.bll.SystemParam" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.zhang.you.uibuilder.SitenavBuilder"%>
<%@ page import="com.zhang.you.bll.*,com.zhang.you.entity.*"%>
...
<div class="index-toolbar">
  <div class="wrap">
    ...
    <%}%>
     ...
     <a href="<%=SystemParam.getSiteRoot()%>/admin/login.jsp">管理员入口</a>
  </div>
       ...
       <form id="searchForm"  action="<%=SystemParam.getSiteRoot() %>/e/searchsp.jsp" method="post" >
        ...
        <div class="search-box">
            <div class="search-text">
                                 商品搜索:</div>
            <div class="keyword">
                <input type="text" placeholder="请输入商品名称" id="spname" name="spname">
            </div>
            <div class="so">
                <input type="submit" class="sobtn" id="btnSearch" value="点击搜索" name="btnSearch">
            </div>
